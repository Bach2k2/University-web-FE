<template>
    <div class="mt-20">
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>
                <a href="/admin/departments/teacher-types">{{ $t('teacher_types') }}</a>
            </el-breadcrumb-item>
        </el-breadcrumb>

        <div class="flex flex-col items-center justify-center pt-10 px-5">
            <PaginationTable :page-size="5" :service="TeacherTypeService" :can-add-items="true" :can-delete-items="true"
