            ...
            <div class="container-lg">
                  <div class="header-top">
                        <div class="header-logo"><img
                              ...
                              <div class="header-sign">AAAAAAAAAAAAAA</div>
                        </div>
                        <div class="header-actions">
                              <div class="header-links dropdown">
                                    ...
                                    <div class="br-list">
                                          ...
                                          </div><a class="br-item" href="javascript:void(0)">Link de acesso 1</a><a
                                                class="br-item" href="javascript:void(0)">Link de acesso 2</a><a
                                                class="br-item" href="javascript:void(0)">Link de acesso 3</a><a
                                          ...
                                          <div class="br-item">
                                                <button class="br-button circle small" type="button"
                                                      aria-label="Funcionalidade 1"><i class="fas fa-chart-bar"
                                                            aria-hidden="true"></i><span class="text">Funcionalidade
                                                            1</span>
                                                </button>
                                          </div>
                                          <div class="br-item">
                              ...
                              <div class="header-search-trigger">
                                    <button class="br-button circle" type="button" aria-label="Abrir Busca"
                                          data-toggle="search" data-target=".header-search"><i class="fas fa-search"
                                                aria-hidden="true"></i>
                                    </button>
                              </div>
                              <div class="header-login">
                                    <div class="header-sign-in">
                                          <button class="br-sign-in small" type="button" data-trigger="login"><i
                  ...
                  <div class="header-bottom">
                        <div class="header-menu">
                              <div class="header-menu-trigger">
                                    <button class="br-button small circle" type="button" aria-label="Menu"
                                          data-toggle="menu" data-target="#main-navigation" id="menu-compact"><i
                        ...
                        <div class="header-search">
                              <div class="br-input has-icon">
                                    <label for="searchbox-57094">Texto da pesquisa</label>
                                    <input id="searchbox-57094" type="text" placeholder="O que você procura?" />
